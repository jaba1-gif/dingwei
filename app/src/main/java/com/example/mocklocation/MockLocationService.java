...
public class MockLocationService extends Service {
    ...
    public static final String ACTION_STATUS = "com.example.mocklocation.STATUS";
    ...
    private final Runnable updateRunnable = new Runnable() {
        ...
        public void run() {
            try {
                ...
                sendStatus(true, "System accepted mock location: " + latitude + ", " + longitude);
                handler.postDelayed(this, UPDATE_INTERVAL_MS);
            } catch (SecurityException error) {
                sendStatus(false, "Mock location is not allowed. Select this app in Developer Options.");
                stopSelf();
            } catch (IllegalArgumentException error) {
                sendStatus(false, "Mock provider failed: " + error.getMessage());
                stopSelf();
            }
        }
    };
    ...
    private void sendStatus(boolean ok, String message) {
